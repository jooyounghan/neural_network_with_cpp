...
public:
	...
	Node* gradient;
public:
	Nag(const float& lr_in, const float& alpha) : Optimizer(lr_in), momentum_alpha(alpha), gradient(new Node) {}
	virtual void optimize(Node& present_gradient) override;
	virtual void naiveOptimize(Node& present_gradient) override;
	virtual Node& getGradient() override;
	virtual ~Nag() override;
};
...
public:
	...
	Node* g_node;
public:
	Adagrad(const float& lr_in, const float& delta_in) : Optimizer(lr_in), g_node(new Node), delta(delta_in) {}
	virtual void optimize(Node& present_gradient) override;
	virtual void naiveOptimize(Node& present_gradient) override;
	virtual Node& getGradient() override;
	virtual ~Adagrad() override;
};
...
public:
	...
	Node* h_node;
public:
	Rmsprop(const float& lr_in, const float& delta_in, const float& gamma_in) : Optimizer(lr_in), h_node(new Node), delta(delta_in), gamma(gamma_in) {}
	virtual void optimize(Node& present_gradient) override;
	virtual void naiveOptimize(Node& present_gradient) override;
	virtual Node& getGradient() override;
...
public:
	Adam(const float& lr_in, const float& delta_in, const float& rho1_in, const float& rho2_in)
		: Optimizer(lr_in), s_node(new Node), r_node(new Node), delta(delta_in), rho1(rho1_in), rho2(rho2_in), t(1) {}
	virtual void optimize(Node& present_gradient) override;
	virtual void naiveOptimize(Node& present_gradient) override;
	virtual Node& getGradient() override;
